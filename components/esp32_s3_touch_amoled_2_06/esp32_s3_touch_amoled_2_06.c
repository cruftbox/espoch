...
esp_err_t bsp_display_new(const bsp_display_config_t *config, esp_lcd_panel_handle_t *ret_panel, esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    /* Drop the QSPI pixel clock from the 40 MHz default to 20 MHz. ESP-IDF v6's
     * SPI driver aborts transfers on "DMA TX underflow" at 40 MHz on this board;
     * 20 MHz transfers reliably and is more than enough for a watch face. */
